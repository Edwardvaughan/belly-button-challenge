...
d3.json ('https://static.bc-edx.com/data/dl-1-2/m14/lms/starter/samples.json').then (function (data) {
  ...
  // This is the dropdown menu of ids.  I can't make it interactive, but you can see the list of ids available
...
function buildMetadata (ID) {
  ...
  d3.json ('https://static.bc-edx.com/data/dl-1-2/m14/lms/starter/samples.json').then (function (data) {
    ...
    // Get the only item in the filteredMetadata array, which is the dictionary with the desired id
