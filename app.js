...
function buildCharts (ID) {
  ...
  d3.json ('https://static.bc-edx.com/data/dl-1-2/m14/lms/starter/samples.json').then (function (data) {
    ...
    // Filter Samples for the sample with the desired id

    var filteredSamples = Samples.filter (object => object.id == ID);

    // Get the only item in the filteredSamples array, which is the dictionary with the desired id
    ...
    var barLayout = {
      title: 'Top 10 Bacteria Cultures Found for Given ID',
